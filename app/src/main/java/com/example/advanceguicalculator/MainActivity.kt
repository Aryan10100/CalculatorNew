...
package com.example.advanceguicalculator
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonIds = arrayOf(R.id.button0, R.id.button1, R.id.button2, R.id.button3, R.id.button4, R.id.button5, R.id.button6, R.id.button7, R.id.button8, R.id.button9, R.id.buttonBr1, R.id.buttonBr2, R.id.backspace, R.id.buttonAC, R.id.buttonAdd,R.id.buttonSubtract, R.id.buttonMultiply, R.id.buttonDivide, R.id.buttonDot, R.id.buttonEquals)
        ...
        for (buttonId in buttonIds) {
            ...
            if (buttonId in arrayOf(R.id.buttonDot, R.id.button0, R.id.button1, R.id.button2, R.id.button3, R.id.button4, R.id.button5, R.id.button6, R.id.button7, R.id.button8, R.id.button9))
            {
                ...
                val drawable = ContextCompat.getDrawable(this, R.drawable.round_button)
                ...
                if (buttonId in arrayOf(R.id.backspace, R.id.buttonAC))
                {
    ...
    private fun setupInputChangeListener() {
        editText.addTextChangedListener(object : TextWatcher {    // on Adding a addTextChangesListener to monitor the change ,,TextWatcher to Watch edit text Change
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {}

            override fun onTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                //calculate and display the result while typing
                val expression = s.toString()
                try{
                    val result = evaluateExpression(expression)
                    resultTextView.setText(result.toString())
                }catch (e : Exception){
                    //handel invalid expression
   ...
   private fun onEqualsButtonClick(){
       ...
       try{
           ...
           val resultInt = result.toInt()   // to convert the result int
